...
class VAPRealTime(AbstractModel):
    def __init__(
        ...
        *,
        runtime: str = 'onnx',
        vap_onnx_model: str = 'vap_state_dict_jp_20hz_2500msec_1x1x1120.onnx',
        providers: List = None,
    ...
    def process_vap(
        ...
        p_now, p_future = super().process_vap(input_datas=[x1_, x2_])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vap_onnx_model", type=str, default='./vap_state_dict_jp_20hz_2500msec_1x1x1120.onnx')
